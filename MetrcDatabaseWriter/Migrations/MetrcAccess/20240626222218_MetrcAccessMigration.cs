        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOwner = table.Column<bool>(type: "smallint", nullable: false),
                    IsManager = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    IsMedical = table.Column<bool>(type: "smallint", nullable: false),
                    IsRetail = table.Column<bool>(type: "smallint", nullable: false),
                    IsHemp = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    CanGrowPlants = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreateOpeningBalancePlantBatches = table.Column<bool>(type: "smallint", nullable: false),
                    CanClonePlantBatches = table.Column<bool>(type: "smallint", nullable: false),
                    CanTagPlantBatches = table.Column<bool>(type: "smallint", nullable: false),
                    CanAssignLocationsToPlantBatches = table.Column<bool>(type: "smallint", nullable: false),
                    PlantsRequirePatientAffiliation = table.Column<bool>(type: "smallint", nullable: false),
                    PlantBatchesCanContainMotherPlants = table.Column<bool>(type: "smallint", nullable: false),
                    CanUpdatePlantStrains = table.Column<bool>(type: "smallint", nullable: false),
                    CanTrackVegetativePlants = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreateImmaturePlantPackagesFromPlants = table.Column<bool>(type: "smallint", nullable: false),
                    CanPackageVegetativePlants = table.Column<bool>(type: "smallint", nullable: false),
                    CanPackageWaste = table.Column<bool>(type: "smallint", nullable: false),
                    CanReportHarvestSchedules = table.Column<bool>(type: "smallint", nullable: false),
                    CanSubmitHarvestsForTesting = table.Column<bool>(type: "smallint", nullable: false),
                    CanRequireHarvestSampleLabTestBatches = table.Column<bool>(type: "smallint", nullable: false),
                    CanReportStrainProperties = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreateOpeningBalancePackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreateDerivedPackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanAssignLocationsToPackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanUpdateLocationsOnPackages = table.Column<bool>(type: "smallint", nullable: false),
                    PackagesRequirePatientAffiliation = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreateTradeSamplePackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanDonatePackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanSubmitPackagesForTesting = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreateProcessValidationPackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanRequirePackageSampleLabTestBatches = table.Column<bool>(type: "smallint", nullable: false),
                    CanRequestProductRemediation = table.Column<bool>(type: "smallint", nullable: false),
                    CanRemediatePackagesWithFailedLabResults = table.Column<bool>(type: "smallint", nullable: false),
                    CanInfuseProducts = table.Column<bool>(type: "smallint", nullable: false),
                    CanRecordProcessingJobs = table.Column<bool>(type: "smallint", nullable: false),
                    CanRecordProductForDestruction = table.Column<bool>(type: "smallint", nullable: false),
                    CanDestroyProduct = table.Column<bool>(type: "smallint", nullable: false),
                    CanTestPackages = table.Column<bool>(type: "smallint", nullable: false),
                    TestsRequireLabSample = table.Column<bool>(type: "smallint", nullable: false),
                    CanTransferFromExternalFacilities = table.Column<bool>(type: "smallint", nullable: false),
                    CanSellToConsumers = table.Column<bool>(type: "smallint", nullable: false),
                    CanSellToPatients = table.Column<bool>(type: "smallint", nullable: false),
                    CanSellToExternalPatients = table.Column<bool>(type: "smallint", nullable: false),
                    CanSellToCaregivers = table.Column<bool>(type: "smallint", nullable: false),
                    CanTakePlantBatchesOnTrip = table.Column<bool>(type: "smallint", nullable: false),
                    CanTakePlantsOnTrip = table.Column<bool>(type: "smallint", nullable: false),
                    CanTakeHarvestsOnTrip = table.Column<bool>(type: "smallint", nullable: false),
                    CanTakePackagesOnTrip = table.Column<bool>(type: "smallint", nullable: false),
                    CanSellFromPackagesOnTrip = table.Column<bool>(type: "smallint", nullable: false),
                    AdvancedSales = table.Column<bool>(type: "smallint", nullable: false),
                    SalesRequirePatientNumber = table.Column<bool>(type: "smallint", nullable: false),
                    SalesRequireExternalPatientNumber = table.Column<bool>(type: "smallint", nullable: false),
                    SalesRequireExternalPatientIdentificationMethod = table.Column<bool>(type: "smallint", nullable: false),
                    SalesRequireCaregiverNumber = table.Column<bool>(type: "smallint", nullable: false),
                    SalesRequireCaregiverPatientNumber = table.Column<bool>(type: "smallint", nullable: false),
                    CanDeliverSalesToConsumers = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryAllowPlannedRoute = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryAllowAddress = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryAllowCity = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryAllowState = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryAllowCounty = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryAllowZip = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryRequireConsumerId = table.Column<bool>(type: "smallint", nullable: false),
                    CanDeliverSalesToPatients = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryRequirePatientNumber = table.Column<bool>(type: "smallint", nullable: false),
                    SalesDeliveryRequireRecipientName = table.Column<bool>(type: "smallint", nullable: false),
                    IsSalesDeliveryHub = table.Column<bool>(type: "smallint", nullable: false),
                    CanHaveMemberPatients = table.Column<bool>(type: "smallint", nullable: false),
                    CanReportPatientCheckIns = table.Column<bool>(type: "smallint", nullable: false),
                    CanSpecifyPatientSalesLimitExemption = table.Column<bool>(type: "smallint", nullable: false),
                    CanReportPatientsAdverseResponses = table.Column<bool>(type: "smallint", nullable: false),
                    RetailerDelivery = table.Column<bool>(type: "smallint", nullable: false),
                    RetailerDeliveryAllowTradeSamples = table.Column<bool>(type: "smallint", nullable: false),
                    RetailerDeliveryAllowDonations = table.Column<bool>(type: "smallint", nullable: false),
                    RetailerDeliveryRequirePrice = table.Column<bool>(type: "smallint", nullable: false),
                    RetailerDeliveryAllowPartialPackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanCreatePartialPackages = table.Column<bool>(type: "smallint", nullable: false),
                    CanAdjustSourcePackagesWithPartials = table.Column<bool>(type: "smallint", nullable: false),
                    CanReportOperationalExceptions = table.Column<bool>(type: "smallint", nullable: false),
                    CanReportAdulteration = table.Column<bool>(type: "smallint", nullable: false),
                    CanGenerateProductLabel = table.Column<bool>(type: "smallint", nullable: false),
                    CanPrintProductLabel = table.Column<bool>(type: "smallint", nullable: false),
                    CanReceiveAssociateProductLabel = table.Column<bool>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsOnHold = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    IsOnTrip = table.Column<bool>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsExpirationDateRequired = table.Column<bool>(type: "smallint", nullable: false),
                    HasExpirationDate = table.Column<bool>(type: "smallint", nullable: false),
                    IsSellByDateRequired = table.Column<bool>(type: "smallint", nullable: false),
                    HasSellByDate = table.Column<bool>(type: "smallint", nullable: false),
                    IsUseByDateRequired = table.Column<bool>(type: "smallint", nullable: false),
                    HasUseByDate = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    IsUsed = table.Column<bool>(type: "smallint", nullable: false)
                },
                constraints: table =>
                {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    FacilityLicense = table.Column<string>(type: "varchar(255)", nullable: false),
                    Name = table.Column<string>(type: "longchar", nullable: false),
                    RequiresTestResult = table.Column<bool>(type: "smallint", nullable: false),
                    InformationalOnly = table.Column<bool>(type: "smallint", nullable: false),
                    AlwaysPasses = table.Column<bool>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IsProductionBatch = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    IsTradeSample = table.Column<bool>(type: "smallint", nullable: false),
                    IsTradeSamplePersistent = table.Column<bool>(type: "smallint", nullable: false),
                    SourcePackageIsTradeSample = table.Column<bool>(type: "smallint", nullable: false),
                    IsDonation = table.Column<bool>(type: "smallint", nullable: false),
                    IsDonationPersistent = table.Column<bool>(type: "smallint", nullable: false),
                    SourcePackageIsDonation = table.Column<bool>(type: "smallint", nullable: false),
                    IsTestingSample = table.Column<bool>(type: "smallint", nullable: false),
                    IsProcessValidationTestingSample = table.Column<bool>(type: "smallint", nullable: false),
                    ProductRequiresRemediation = table.Column<bool>(type: "smallint", nullable: false),
                    ContainsRemediatedProduct = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    FinishedDate = table.Column<DateTime>(type: "datetime", nullable: true),
                    IsOnTrip = table.Column<bool>(type: "smallint", nullable: false),
                    IsOnRetailerDelivery = table.Column<bool>(type: "smallint", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    TestPassed = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    OverallPassed = table.Column<bool>(type: "smallint", nullable: false),
                    ...
                    TestInformationalOnly = table.Column<bool>(type: "smallint", nullable: false),
                    ResultReleased = table.Column<bool>(type: "smallint", nullable: false),
